        ...
        <div class="row">
           ...
           <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">Manege Items</h5>
                <div class="table-responsive">
                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <c:forEach items="${items}" var="item">
                      <tr>
                        <td class="border-bottom-0"><h6 class="fw-semibold mb-0">${item.itemId}</h6></td>
                        <td class="border-bottom-0">
                            <p class="mb-0 fw-normal">${item.itemName}</p>                         
                        </td>
                        <td class="border-bottom-0">
                            <p class="mb-0 fw-normal">${item.itemBrand}</p>                         
                        </td>
                        <td class="border-bottom-0">
                          <p class="mb-0 fw-normal">${item.itemQty}</p>
                        </td>
                        <td class="border-bottom-0">
                          <div class="d-flex align-items-center gap-2">
                            <span class="badge bg-primary rounded-3 fw-semibold">${item.itemPrice}</span>
                          </div>
                        </td>
                        <td class="border-bottom-0">
                          <h6 class="fw-semibold mb-0 fs-4">${item.itemSupplier}</h6>
                        </td>
                        <td class="border-bottom-0">
                          <form action="ItemReadyUpdateServlet" method="post">

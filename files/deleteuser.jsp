...
<body>
 ...
 <c:forEach var="usr1" items="${userDataDel}">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Delete Suplier</h5>
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="mb-3">
                      ...
                      <div id="emailHelp" class="form-text">Default Suplier ID</div>
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">User Name</label>
                      <input type="text" class="form-control" id="username" name="username" value="${usr1.username}" aria-describedby="emailHelp">
                      <div id="emailHelp" class="form-text">Enter System Suplier Default UserName</div>
                    </div>
                    <div class="mb-3">
                      ...
                      <div id="emailHelp" class="form-text">Enter System Suplier By Default Password </div>
                    </div>
                    <div class="mb-3">
                      ...
                      <div id="emailHelp" class="form-text">Enter Suplier First Name</div>
                    </div>
                    <div class="mb-3">
                      ...
                      <div id="emailHelp" class="form-text">Enter Suplier Last Name</div>
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Address </label>
                      <input type="text" class="form-control" id="address" name="address" value="${usr1.address}" aria-describedby="emailHelp">
                      <div id="emailHelp" class="form-text">Enter Suplier Address</div>
                    </div>
                    <div class="mb-3">
                      ...
                      <div id="emailHelp" class="form-text">Enter Suplier Contact Number</div>
                    </div>
                    <div class="mb-3">
                      ...
                      <div id="emailHelp" class="form-text">Enter Suplier Email Address</div>
                    </div>
                    <div class="mb-3">
                      ...
                      <div id="emailHelp" class="form-text">Enter Suplier National Identity Card Number</div>
                    </div>
                    <div class="mb-3">
        ...
        <c:choose>
            ...
            <c:when test="${usr1.type eq 'supplier'}">
                <option value="supplier" selected="selected">Supplier  "Current Role"</option>
                    ...
                    <button type="submit" class="btn btn-secondary m-1" onclick="setAction('UserDeleteServlet')">Delete User Profile</button>

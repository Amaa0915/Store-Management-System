                ...
                <div class="card-body">
                  <form action="AddItemServlet" method="post">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="item_name" name="item_name" aria-describedby="emailHelp" required>
                      <div id="emailHelp" class="form-text">Enter Item Name Hear</div>
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Item Brand </label>
                      <input type="text" class="form-control" id="item_brand" name="item_brand" aria-describedby="emailHelp" required>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="number" class="form-control" id="item_qty" name="item_qty" aria-describedby="emailHelp" required>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="number" class="form-control" id="item_price" name="item_price" aria-describedby="emailHelp" required>
                    ...
                    <div class="mb-3">
                      ...
                      <textarea class="form-control" id="item_discription" name="item_discription" aria-describedby="emailHelp" rows="4" cols="50"></textarea>

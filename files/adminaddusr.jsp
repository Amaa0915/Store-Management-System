    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Add Suplier</h5>
              <div class="card">
                <div class="card-body">
                  <form action="AddServlet" method="post">
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Suplier UserName</label>
                    ...
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        <label for="disabledSelect" class="form-label">Set Suplier Status</label>
                        <select id="userStaus" name="userStaus" class="form-select">

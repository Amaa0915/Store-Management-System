        ...
        <div class="row">
            ...
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">View All Supplers </h5>
                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    <thead class="text-dark fs-4">
                      ...
                      <th class="border-bottom-0">
                        ...
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">Supplier First Name</h6>
                        </th>
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0"> SupplierTelephone</h6>
                        </th>
                        <th class="border-bottom-0">

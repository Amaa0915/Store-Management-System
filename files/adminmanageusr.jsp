        ...
        <div class="row">
            ...
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">Manege Users</h5>
                <div class="table-responsive">
                  <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                      <tr>
                        <td class="border-bottom-0"><h6 class="fw-semibold mb-0">${users.user_id}</h6></td>
                        <td class="border-bottom-0">
                            <p class="fw-semibold mb-0 fs-4">${users.username}</p>                         
                        </td>
                        <td class="border-bottom-0">
                          <p class="fw-semibold mb-0 fs-4">${users.first_name}</p>
                        </td>
                        <td class="border-bottom-0">
                          <div class="d-flex align-items-center gap-2">
                            <span class="fw-semibold mb-0 fs-4">${users.telephone_no}</span>
                          </div>
                        </td>
                        <td class="border-bottom-0">
                          <h6 class="fw-semibold mb-0 fs-4">${users.email}</h6>
                        </td>
                        <td class="border-bottom-0">
                        <form action="UserReadyUpdateServlet" method="post">
        						<input type="text" name="user_id" id="user_id" value="${users.user_id}" hidden />

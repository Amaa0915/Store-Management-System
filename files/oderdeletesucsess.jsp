    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Delete Oder</h5>
              <div class="card">
                
                
                <div class="alert alert-success" role="alert">
                    Oder Delete SucsessFully !
                  </div>
        ...
        setTimeout(function () {
            window.location.href = 'DisplayAllOdersDeleteServlet'; // Replace 'your_target_page.jsp' with the actual URL you want to redirect to

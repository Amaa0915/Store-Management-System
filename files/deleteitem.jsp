    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Delete Item</h5>
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="item_name" name="item_name" value="${items.itemName}" aria-describedby="emailHelp" required readonly>
                      <div id="emailHelp" class="form-text">Enter Item Name Hear</div>
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Item Brand </label>
                      <input type="text" class="form-control" id="item_brand" name="item_brand" value="${items.itemBrand}" aria-describedby="emailHelp" required readonly>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="number" class="form-control" id="item_qty" name="item_qty" value="${items.itemQty}" aria-describedby="emailHelp" required readonly>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="number" class="form-control" id="item_price" name="item_price" value="${items.itemPrice}" aria-describedby="emailHelp" required readonly>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="item_supplier" name="item_supplier" class="form-select">
                          ...
                          <option value="Supplier 03">Supplier 03</option>
                        </select>
                      ...
                      <label for="exampleInputEmail1" class="form-label">Item Discription</label>
             		  ...
             		  <input type="text" class="form-control" id="item_brand" name="item_brand" value="${items.itemDescription}" aria-describedby="emailHelp" readonly>

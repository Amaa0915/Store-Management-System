...
<body>
 ...
 <c:forEach var="usr" items="${usrDetails}">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="mb-3">
                      ...
                      <input type="number" class="form-control" id="user_id" name="user_id" value="${usr.user_id}" aria-describedby="emailHelp" readonly>
                      <div id="emailHelp" class="form-text">Default User ID</div>
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">User Name</label>
                      <input type="text" class="form-control" id="username" name="username" value="${usr.username}" aria-describedby="emailHelp">
                      <div id="emailHelp" class="form-text">Enter System User Default UserName</div>
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Password</label>
                      <input type="password" class="form-control" id="password" name="password"  value="${usr.password}"  aria-describedby="emailHelp">
                      <div id="emailHelp" class="form-text">Enter System User By Default Password </div>
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">First Name</label>
                      <input type="text" class="form-control" id="first_name" name="first_name" value="${usr.first_name}" aria-describedby="emailHelp">
                      <div id="emailHelp" class="form-text">Enter User First Name</div>
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Last Name</label>
                      <input type="text" class="form-control" id="last_name" name="last_name" value="${usr.last_name}" aria-describedby="emailHelp">
                      <div id="emailHelp" class="form-text">Enter User Last Name</div>
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Address </label>
                      <input type="text" class="form-control" id="address" name="address" value="${usr.address}" aria-describedby="emailHelp">
                      <div id="emailHelp" class="form-text">Enter User Address</div>
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Telephone </label>
                      <input type="number" class="form-control" id="telephone_no"  name="telephone_no" value="${usr.telephone_no}" aria-describedby="emailHelp">
                      <div id="emailHelp" class="form-text">Enter User Contact Number</div>
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Email </label>
                      <input type="email" class="form-control" id="exampleInputEmail1" name="email" value="${usr.email}" aria-describedby="emailHelp">
                      <div id="emailHelp" class="form-text">Enter User Email Address</div>
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">NIC </label>
                      <input type="text" class="form-control" id="nic" name="nic" value="${usr.nic}" aria-describedby="emailHelp">
    ...
    <select id="userType" name="type" class="form-select" required>
        <c:choose>
            <c:when test="${usr.type eq 'admin'}">
                <option value="admin" selected="selected">Admin  "Current Role"</option>
                <option value="supplier">Supplier</option>
                <option value="manager">Manager</option>
                <option value="warehousemanager">Warehouse Manager</option>
                <option value="cashier">Cashier</option>
            </c:when>
            <c:when test="${usr.type eq 'supplier'}">
            ...
            <c:when test="${usr.type eq 'manager'}">
                <option value="manager" selected="selected">Manager  "Current Role"</option>
                <option value="admin">Admin</option>
                <option value="supplier">Supplier</option>
                <option value="warehousemanager">Warehouse Manager</option>
                <option value="cashier">Cashier</option>
            </c:when>
            <c:when test="${usr.type eq 'warehousemanager'}">
                <option value="warehousemanager" selected="selected">Warehouse Manager  "Current Role"</option>
                <option value="admin">Admin</option>
                <option value="supplier">Supplier</option>
                <option value="manager">Manager</option>
                <option value="cashier">Cashier</option>
            </c:when>
            <c:when test="${usr.type eq 'cashier'}">
            ...
            <c:otherwise>
                ...
                <option value="cashier">Cashier</option>
                    ...
                    <button type="submit" class="btn btn-secondary m-1" onclick="setAction('UpdateUserServlet')">Update Your Profile</button>
  ...
  <% 
  String type = request.getParameter("${usr.type}");
%>
<script>

    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Make An Order</h5>
              <div class="card">
                <div class="card-body">
                  <form method="post" action="AddOderServlet">
                  	
                     <div class="mb-3">
                        <label for="disabledSelect" class="form-label">Select Item</label>
                    ...
                    <div class="mb-3">
                        <label for="disabledSelect" class="form-label">Select Name</label>
                    ...
                    <div class="mb-3">
                      ...
                      <div id="emailHelp" class="form-text">Enter Requwired Item Quantity</div>
                    </div>
                    <div class="mb-3">
                      ...
                      <div id="emailHelp" class="form-text">Enter Odering Data</div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-outline-primary m-1">Create Order</button>
                  </form>
                </div>
              </div>
